...
| [no-composite-primary-key](https://baseballyama.github.io/eslint-plugin-postgresql/rules/no-composite-primary-key)                               | Disallow composite (multi-column) PRIMARY KEY constraints                  |             |
...
| [no-locking-subquery-with-limit](https://baseballyama.github.io/eslint-plugin-postgresql/rules/no-locking-subquery-with-limit)                   | Disallow a locking sub-`SELECT` with `LIMIT` in `UPDATE` / `DELETE`        |     ✅      |
...
| [require-fk-include-columns](https://baseballyama.github.io/eslint-plugin-postgresql/rules/require-fk-include-columns)                           | Require every FK to include a configured set of columns (e.g. `tenant_id`) |             |
...
| [require-table-columns](https://baseballyama.github.io/eslint-plugin-postgresql/rules/require-table-columns)                                     | Require every `CREATE TABLE` to include a configured set of columns        |             |
