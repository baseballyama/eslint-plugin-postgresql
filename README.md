...
| [require-trailing-semicolon](https://baseballyama.github.io/eslint-plugin-postgresql/rules/require-trailing-semicolon)                         | Require a trailing `;` at the end of the SQL file                          |     🎨      |
